...
LABEL maintainer="chengli.zou <chengli.zou@gmail.com>" version="8.7.1"
...
&& curl -o ${AGENT_PATH}/${AGENT_FILENAME}  https://github.com/zouchengli/jira/releases/download/v${AGENT_VERSION}/atlassian-agent.jar -L \
